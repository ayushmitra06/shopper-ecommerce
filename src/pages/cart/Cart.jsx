...
import { addToCart, removeOneFromCart, deleteFromCart } from '../../redux/cartSlice';
...
function Cart() {
  ...
  useEffect(() => {
    ...
    cartItems.forEach(cartItem => {
      tempAmount += cartItem.price * cartItem.quantity;
    });
                      ...
                      <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                        <div className="mt-5 sm:mt-0">
                          ...
                          <div className="flex items-center mt-2">
                            <button onClick={() => dispatch(removeOneFromCart(item))} className="text-gray-500 hover:text-gray-700">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M18 12H6" />
                              </svg>
                            </button>
                            <span className="mx-2 text-lg font-semibold">{quantity}</span>
                            <button onClick={() => dispatch(addToCart(item))} className="text-gray-500 hover:text-gray-700">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
